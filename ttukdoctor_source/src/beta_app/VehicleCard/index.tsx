...
export const DetailedVehicleCard:React.FC<DetailProps> = ({onClick, start='', end='', imgSrc, plateNumber, modelName, repairMethod, location, requestType, errorType, quoteCount}) =>{
    const router = useIonRouter();
    
    return (
         <div onClick = {onClick} className="vehicle-card-button" style={{display: 'flex', flexDirection: 'column',  borderRadius: '12px', backgroundColor: 'white', padding: '8px', gap: '8px', width: '100%', }} >
