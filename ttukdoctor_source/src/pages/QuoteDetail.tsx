...
const QuoteDetail = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await addDoc(collection(db, "QuoteOffers"), {
        quoteRequestId: id,
        userId: quote.userId,  // ✅ 고객 ID (건설기계 운용자)
        modelName: quote.modelName,
        location: quote.location,
        errorCode: quote.errorCode,
        mediaUrl: quote.mediaUrl,
        repairDetail: quoteDetail,
        cost: quoteCost,
        ETA: {
          day: ETA_day,
          hour: ETA_hour,
    ...
    <IonPage> 
      <IonContent>
        <div className="container">
          ...
          <Button content="견적 보내기" color="orange" onClick={handleSubmit} />
