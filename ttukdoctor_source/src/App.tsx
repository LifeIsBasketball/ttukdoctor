...
import GarageDetailHC from './pages/GarageDetailHC';
...
import Status3 from './pages/Status3';
import Status4 from './pages/Status4';
  ...
  <IonApp>
    <IonReactRouter>
      ...
      <Route path="/tabs2">
        ...
        <Route exact path="/status2/:docId">
          <Status2 />
        </Route>
        <Route exact path="/status3/:docId">
          <Status3 />
        </Route>
        <Route exact path="/status4/:docId">
          <Status4 />
        </Route>
        ...
        <Route exact path="/garagedetailhc"> 
          <GarageDetailHC/>
        </Route>
